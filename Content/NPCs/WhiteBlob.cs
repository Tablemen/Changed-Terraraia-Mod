...
namespace changedmod.Content.NPCs
{
	...
	public class WhiteBlob : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			NPCID.Sets.ShimmerTransformToNPC[NPC.type] = NPCID.DuckWhite;
		}
		...
		public override void SetDefaults() {
			...
			NPC.DeathSound = SoundID.NPCDeath23; // The sound the NPC will make when it dies.
			NPC.value = 25f; // How many copper coins the NPC will drop when killed.
		}

		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			// we would like this npc to spawn in the overworld.
			return SpawnCondition.OverworldDaySlime.Chance * 1.0f;
		}
		...
		public override bool ModifyCollisionData(Rectangle victimHitbox, ref int immunityCooldownSlot, ref MultipliableFloat damageMultiplier, ref Rectangle npcHitbox) {
			...
			if (AI_State == (float)ActionState.Fall) {
				...
				if (victimHitbox.Intersects(extraDamageHitbox)) {
					damageMultiplier *= 2f;
					Main.NewText("You begin feeling tired");
				}
			}
			return true;
		}
