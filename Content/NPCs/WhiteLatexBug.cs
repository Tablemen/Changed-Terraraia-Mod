...
namespace changedmod.Content.NPCs
{
	...
	/// </summary>
	public class WhiteLatexBugNPC : ModNPC
	{
		...
		private void HookFrogStatue(ILContext ilContext) {
			try {
				...
				MonoModHooks.DumpIL(ModContent.GetInstance<changedmod>(), ilContext);
			}
		}
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			bestiaryEntry.AddTags(BestiaryDatabaseNPCsPopulator.CommonTags.SpawnConditions.Biomes.Surface,
				new FlavorTextBestiaryInfoElement("The most adorable goo child. Do not dare be mean to him!"));
		}

		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			return SpawnCondition.Overworld.Chance * 1.0f;
		}
