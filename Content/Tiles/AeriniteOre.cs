...
{
	public class AeriniteOre : ModTile
	{
        ...
        public override void SetStaticDefaults() {
            ...
            ItemDrop = ModContent.ItemType<Items.Placeable.AeriniteOre>();
	...
	public class AeriniteOreSystem : ModSystem
	{
		public static LocalizedText AeriniteOrePassMessage { get; private set; }

		public override void SetStaticDefaults() {
			AeriniteOrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(AeriniteOrePassMessage)}");
		}
		...
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight) {
			...
			if (ShiniesIndex != -1) {
				...
				tasks.Insert(ShiniesIndex + 1, new AeriniteOrePass("Aerinite Ore", 237.4298f));
			}
		}
	}

	public class AeriniteOrePass : GenPass
	{
		public AeriniteOrePass(string name, float loadWeight) : base(name, loadWeight) {
		}
		...
		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration) {
			...
			progress.Message = AeriniteOreSystem.AeriniteOrePassMessage.Value;
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++) {
				...
				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(2, 5), WorldGen.genRand.Next(2, 3), ModContent.TileType<AeriniteOre>());
