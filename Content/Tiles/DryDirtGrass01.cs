...
namespace changedmod.Content.Tiles
{
	...
	public abstract class DryDirtGrass01Base : ModTile
	{
		// We want both tiles to use the same texture
		public override string Texture => "changedmod/Content/Tiles/DryDirtGrass01";
	...
	public class DryDirtGrass01Fake : DryDirtGrass01Base
	{
		public override void SetStaticDefaults() {
			...
			FlexibleTileWand.RubblePlacementSmall.AddVariations(ModContent.ItemType<Items.Placeable.DryDirtBlock>(), Type, 0, 1, 2, 3, 4, 5);

			// Tiles placed by Rubblemaker drop the item used to place them.
			RegisterItemDrop(ModContent.ItemType<Items.Placeable.DryDirtBlock>());
		}
	}

	// This is the natural tile, this version is placed during world generation in the RubbleWorldGen class.
	public class DryDirtGrass01Natural : DryDirtGrass01Base
	{
		public override void SetStaticDefaults() {
			base.SetStaticDefaults();
