using changedmod.Content.Biomes;
...
namespace changedmod.Content.Tiles
{
	...
	public class CityRuinsTorch : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			*/
			...
			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("changedmod/Content/Tiles/CityRuinsTorch_Flame");
			}
		}
		...
		public override float GetTorchLuck(Player player) {
			...
			bool inExampleUndergroundBiome = player.InModBiome<CityRuinsUndergroundBiome>();
