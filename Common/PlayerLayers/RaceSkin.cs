	...
	public class RaceTorso : PlayerDrawLayer
	{
		...
		protected override void Draw(ref PlayerDrawSet drawInfo) 
		{
			...
			if (changedmodPlayer.race != null) {
				TextureAssets.Players[drawInfo.skinVar, 3] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 4] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 6] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 10] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 11] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 12] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");

				CensorShirt_Texture = changedmodPlayer.GetRaceTexture(drawPlayer, "Clothes/CensorShirt", "changedmod/Assets/Textures/Players/Clothes/CensorShirt");
				CensorPants_Texture = changedmodPlayer.GetRaceTexture(drawPlayer, "Clothes/CensorPants", "changedmod/Assets/Textures/Players/Clothes/CensorPants");
				...
				for (int i = 0; i < 5; i++)
				{
					...
					Pants_Texture[male[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Pants", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/Pants");
					Shoes_Texture[male[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Shoes", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/Shoes");
					...
					PantsAddition_Texture[male[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/PantsAddition", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/PantsAddition");
				}
				...
				for (int i = 0; i < 5; i++)
				{
					...
					Pants_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Pants", $"changedmod/Assets/Textures/Players/Clothes/Female/Clothes/Style_{i + 1}/Pants");
					Shoes_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Shoes", $"changedmod/Assets/Textures/Players/Clothes/Female/Clothes/Style_{i + 1}/Shoes");
					...
					PantsAddition_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/PantsAddition", $"changedmod/Assets/Textures/Players/Clothes/Female/Clothes/Style_{i + 1}/PantsAddition");
				}
				
				for (int i = 0; i < 10; i++)
				{
					Body_Texture[i] = changedmodPlayer.GetRaceTexture(drawPlayer, $"{PlayerColors[i]}/Body");
					Legs_Texture[i] = changedmodPlayer.GetRaceTexture(drawPlayer, $"{PlayerColors[i]}/Legs");
				}
				...
				if (!drawPlayer.invis)
				{
					...
					if (!(drawPlayer.armor[1].type == ItemID.FamiliarShirt || drawPlayer.armor[11].type == ItemID.FamiliarShirt) && changedmodPlayer.race.CensorClothing)
					{
					...
					if (!(drawPlayer.armor[2].type == ItemID.FamiliarPants || drawPlayer.armor[12].type == ItemID.FamiliarPants) && changedmodPlayer.race.CensorClothing)
					{
						if (drawInfo.isSitting)
						{
