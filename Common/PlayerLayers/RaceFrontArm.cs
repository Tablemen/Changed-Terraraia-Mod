	...
	public class RaceFrontArm : PlayerDrawLayer
	{
		...
		protected override void Draw(ref PlayerDrawSet drawInfo) 
		{
			...
			if (changedmodPlayer.race != null) {
				...
				TextureAssets.Players[drawInfo.skinVar, 8] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 9] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 13] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				TextureAssets.Players[drawInfo.skinVar, 14] = ModContent.Request<Texture2D>("changedmod/Patches/Blank");
				...
				for (int i = 0; i < 5; i++)
				{
					Shirt_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Shirt", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/Shirt");
					Undershirt_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/Undershirt", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/Undershirt");
					ShirtAddition_Texture[female[i]] = changedmodPlayer.GetRaceTexture(drawPlayer, $"Clothes/Style_{i + 1}/ShirtAddition", $"changedmod/Assets/Textures/Players/Clothes/Male/Clothes/Style_{i + 1}/ShirtAddition");
				}
