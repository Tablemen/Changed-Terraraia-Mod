...
namespace changedmod.MainMenu
{
    public class changedmodMainMenu : ModMenu
    {
        public class Cinder
        {
            public int Time;
        ...
        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("changedmod/MainMenu/Logo");
        public override Asset<Texture2D> SunTexture => ModContent.Request<Texture2D>("changedmod/Patches/BlankPixel");
        public override Asset<Texture2D> MoonTexture => ModContent.Request<Texture2D>("changedmod/Patches/BlankPixel");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("changedmod/MainMenu/MenuBackground").Value;
            ...
            // Draw cinders.
            Texture2D cinderTexture = ModContent.Request<Texture2D>("Changedmod/Patches/CalamitasCinder").Value;
            for (int i = 0; i < Cinders.Count; i++)
            {
